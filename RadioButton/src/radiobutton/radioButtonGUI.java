 ...
 * @author Laura
 */
public class radioButtonGUI extends javax.swing.JFrame {

    /**
     * Creates new form radioButtonGUI
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Qual é o seu sintema operacional?");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jrbAndroid)
                .addGap(18, 18, 18)
                .addComponent(jbConfirmar, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addGap(30, 30, 30))
        );
    ...
    private void jbConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbConfirmarActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Sistema operacional escolhido: " + getOpcaoSelecionada());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(radioButtonGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new radioButtonGUI().setVisible(true);
            }
        });
    }
